...
class ExpressCheckout extends OffsitePaymentGatewayBase implements ExpressCheckoutInterface {
  ...
  public const SHIPPING_ASK_ALWAYS = 'shipping_ask_always';
  public const SHIPPING_ASK_NOT_PRESENT = 'shipping_ask_not_present';
  public const SHIPPING_SKIP = 'shipping_skip';
  ...
  public function onReturn(OrderInterface $order, Request $request) {
    ...
    // If the user is anonymous, add their PayPal email to the order.
    if (empty($order->mail)) {
