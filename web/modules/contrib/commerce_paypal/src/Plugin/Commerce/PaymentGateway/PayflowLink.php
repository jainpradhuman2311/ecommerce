...
use Drupal\commerce_paypal\PluginForm\PaymentReferenceForm;
...
class PayflowLink extends OffsitePaymentGatewayBase implements PayflowLinkInterface {
   ...
   */
  public const BUTTON_SOURCE = 'CommerceGuys_Cart_PFL';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['emailcustomer'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Instruct PayPal to email payment receipts to your customers upon payment.'),
  ...
  protected function getDefaultForms() {
    ...
    $default_forms['reference-payment'] = PaymentReferenceForm::class;
  ...
  protected function apiRequest($api, array $nvp = [], $order = NULL) {
    ...
    $this->eventDispatcher->dispatch($event, PayPalEvents::PAYFLOW_LINK_REQUEST);
