...
class __TwigTemplate_42432f104988ff9cea361c16485eb2c3 extends Template
{
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/Applications/MAMP/htdocs/kickstart/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
